...
There is a cool paper about canadian horses [@milner1969weight].
...
```{r plot horses, fig.width=10, fig.height=3, fig.cap="Figure 1. Horse population for each province in Canada.",out.width='100%'}
...
max_horses <- horse_pop %>% 
  ...
  summarize(Maximum = max(Value),
            Minimum = min(Value))
kable(max_horses,
      caption='table1: Maximum and Minimum population of horses between 1940 and 1972')
```

Below we zoom in and look at the province of `r params$province`:

```{r plot province, fig.width=5, fig.height=4, fig.cap="Figure2. Figure of our focus.",out.width="50%"}
